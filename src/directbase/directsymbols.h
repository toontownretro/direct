...
/* BUILDING_DIRECT is just a buildsystem shortcut for all of these: */
  ...
  #define BUILDING_DIRECT_STUB
  #define BUILDING_DIRECT_ACTOR
  #define BUILDING_DIRECT_DCPARSER
  #define BUILDING_DIRECT_DEADREC
  #define BUILDING_DIRECT_DIRECTBASE
  ...
  #define BUILDING_DIRECT_DISTRIBUTED2
  #define BUILDING_DIRECT_FOUNDRY
  #define BUILDING_DIRECT_HTTP
#endif


#ifdef BUILDING_DIRECT_STUB
  #define EXPCL_DIRECT_STUB EXPORT_CLASS
  #define EXPTP_DIRECT_STUB EXPORT_TEMPL
#else
  #define EXPCL_DIRECT_STUB IMPORT_CLASS
  #define EXPTP_DIRECT_STUB IMPORT_TEMPL
#endif
  
#ifdef BUILDING_DIRECT_ACTOR
  #define EXPCL_DIRECT_ACTOR EXPORT_CLASS
  #define EXPTP_DIRECT_ACTOR EXPORT_TEMPL
#else
  #define EXPCL_DIRECT_ACTOR IMPORT_CLASS
  #define EXPTP_DIRECT_ACTOR IMPORT_TEMPL
#endif
...
#ifdef BUILDING_DIRECT_DIRECTBASE
  #define EXPCL_DIRECT_DIRECTBASE EXPORT_CLASS
  #define EXPTP_DIRECT_DIRECTBASE EXPORT_TEMPL
#else
  #define EXPCL_DIRECT_DIRECTBASE IMPORT_CLASS
  #define EXPTP_DIRECT_DIRECTBASE IMPORT_TEMPL
#endif
...
#ifdef BUILDING_DIRECT_DISTRIBUTED2
  #define EXPCL_DIRECT_DISTRIBUTED2 EXPORT_CLASS
  #define EXPTP_DIRECT_DISTRIBUTED2 EXPORT_TEMPL
#else
  #define EXPCL_DIRECT_DISTRIBUTED2 IMPORT_CLASS
  #define EXPTP_DIRECT_DISTRIBUTED2 IMPORT_TEMPL
#endif

#ifdef BUILDING_DIRECT_FOUNDRY
  #define EXPCL_DIRECT_FOUNDRY EXPORT_CLASS
  #define EXPTP_DIRECT_FOUNDRY EXPORT_TEMPL
#else
  #define EXPCL_DIRECT_FOUNDRY IMPORT_CLASS
  #define EXPTP_DIRECT_FOUNDRY IMPORT_TEMPL
#endif

#ifdef BUILDING_DIRECT_HTTP
  #define EXPCL_DIRECT_HTTP EXPORT_CLASS
  #define EXPTP_DIRECT_HTTP EXPORT_TEMPL
#else
  #define EXPCL_DIRECT_HTTP IMPORT_CLASS
  #define EXPTP_DIRECT_HTTP IMPORT_TEMPL
#endif
